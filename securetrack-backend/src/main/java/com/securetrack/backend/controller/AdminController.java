...
public class AdminController {
    ...
    // ================= Container Owner Endpoints =================
    @PutMapping("/users/owners/{ownerId}/deactivate")
    public ResponseEntity<ApiResponse> deactivateOwner(@PathVariable Long ownerId) {
        userManagementService.deactivateOwner(ownerId);
        return ResponseEntity.ok(ApiResponse.ok("Owner account deactivated"));
    }

    @DeleteMapping("/users/owners/{ownerId}")
    public ResponseEntity<ApiResponse> deleteOwner(@PathVariable Long ownerId) {
        userManagementService.deleteOwner(ownerId);
        return ResponseEntity.ok(ApiResponse.ok("Owner account deleted"));
    }
