...
import { FiBox, FiAlertTriangle, FiTrendingUp, FiClock, FiGrid, FiSearch, FiBell, FiUsers, FiFileText, FiSettings, FiLogOut } from 'react-icons/fi';
...
const InspectorDashboard = () => {
    ...
    console.log("Submitting Payload:", initForm); 
                ...
                <div className="cgo-workspace">
                    ...
                    <section className="cgo-metrics-grid">
                        <div className="cgo-metric-box">
                            ...
                            <div className="cgo-bubble b-blue"><FiBox/></div>
                        </div>
                        ...
                        <div className="cgo-metric-box">
                            ...
                            <div className="cgo-bubble b-red"><FiAlertTriangle/></div>
                        </div>
                        ...
                        <div className="cgo-metric-box">
                            ...
                            <div className="cgo-bubble b-green"><FiTrendingUp/></div>
                        </div>
                        ...
                        <div className="cgo-metric-box">
                            ...
                            <div className="cgo-bubble b-purple"><FiClock/></div>
                        </div>
                    </section>
